...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?php echo DIR_TEMPLATE ?>admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo URL::createLink('admin',$this->request['controller'],'postLogin') ?>" method="post">
