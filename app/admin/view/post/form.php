<?php 
  ...
  $select_category_default = ['-- Chọn danh mục --'];
  $select_category =  $select_category_default + $this->itemsCategory;
?>
  <div class="content-wrapper" style="min-height: 228px;">
  <?php echo Helper::render_admin_header('Post::Form') ?>
    <div class="content">
              ...
              <form id="frmData" role="form" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                      ...
                      <div class="form-group">
                        <label>Content</label>
                        <textarea name="form[content]" class="form-control" name="" id="content" cols="30" rows="3"><?php echo isset($this->item['content']) ? $this->item['content'] : "" ?></textarea>
                      </div>
                      <div class="form-group">
                            <label>Danh mục</label>
                            <select name="form[category_id]" class="custom-select">
                            <?php echo Helper::create_select($select_category, $this->item['category_id']) ?>
                            </select>
                      </div>
                      <div class="form-group">
                            <label>Status</label>
                      ...
                      <div class="form-group">
                        ...
                        <?php if(isset($this->request['id'])) {?>
                          <div class="preview_img">
                              <img src="<?php echo  DIR_UPLOAD.'post/standard/' . $this->item['picture'] ?>">
                          </div>
